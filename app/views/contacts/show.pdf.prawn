...
pdf.text "Jilion - Contact", h1
pdf.text "Submited on https://jilion.com/contact the #{I18n.l(@contact.created_at, :format => :long)}", p.merge(:style => :italic)
...
pdf.indent(p_indent) { pdf.text @contact.activity, p.merge(:leading => 20) }
