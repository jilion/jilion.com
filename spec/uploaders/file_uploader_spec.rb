...
describe FileUploader do
  let(:contact_created_before_oct_7_2013) { create(:contact, created_at: Time.utc(2013, 10, 7, 10, 25)) }
  let(:contact_created_after_oct_7_2013) { create(:contact, created_at: Time.utc(2013, 10, 7, 10, 26)) }
